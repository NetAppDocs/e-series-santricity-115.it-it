...
È possibile accedere alle statistiche di iSER su InfiniBand dalla pagina System (sistema) (menu:Impostazioni[sistema]) o dalla pagina Support (supporto). Queste istruzioni descrivono come accedere alle statistiche dalla pagina di supporto.
